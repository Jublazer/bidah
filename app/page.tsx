...
export default function Home() {
  ...
  return (
    <div className="font-sans flex flex-col w-full bg-gradient-to-br from-green-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 items-center justify-center min-h-screen md:px-30  mx-auto">
