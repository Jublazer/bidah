    ...
    return(
        <div className="w-full h-auto py-8 px-4 sm:px-6 lg:px-8">
            ...
            <div className="w-full relative mx-auto flex flex-col justify-center items-center md:flex-row">
                ...
                <div className="max-h-[350px]  top-0 md:sticky bg-green-800 max-w-[300px] p-5 mb-8 ">
                    ...
                    <div className="flex flex-col justify-start w-full gap-4 mb-6">
                                ...
                                <div className="flex flex-col justify-center w-full">
                                    ...
                                    className="px-2 py-2 bg-white/20 text-gray-300 rounded-sm transform-colors hover:bg-green-800 hover:border-white-400 hover:text-white-400 transition-colors"
                                    >
                                    Clear Filters
                                    </button>
                                </div>
                        ...
                        {/* Results Section */}
                    <div className="bg-white/55 glass w-full rounded-lg shadow-md p-6">
...
export const Categories = ()=>{
    ...
    const cats = [...new Set(produceData.map((item=>item.category)))]
        ...
        <>
                <div className="w-full flex flex-col ">
                    ...
                    <h2 className="text-gray-400">Categories: </h2>
                        ...
                        {cats.map((category) => (
                            <option key={category} value={category} className="bg-gray-800 text-green-400">
                            {category}
                            </option>
                            ))}
                            </select>
                ...
                <div className="place-items-center w-full grid md:grid-cols-4 sm:grid-cols-3 xl:grid-cols-5 min-h-screen gap-3 md:gap-5 lg:gap-5 sm:gap-3 p-3 ">
                    ...
                    <div key={filteredProduct.pid} className="relative flex items-center justify-center overflow-y-clip bg-white/30 text-dark w-[250px] h-[250px] border border-solid rounded-lg shadowed-xlg">
                        ...
                        ">
                            ...
                            <button onClick={() => handleProduceClick(filteredProduct.pid)} type="button" className="p-1 border w-full mx-auto cursor-pointer rounded-sm btn
